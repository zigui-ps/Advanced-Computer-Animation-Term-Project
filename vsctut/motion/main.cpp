...
void drawjoint(JOINT* joint, MOTION* motionData, int frame_starts_index, Shader ourShader);

// settings
const unsigned int SCR_WIDTH = 800;
const unsigned int SCR_HEIGHT = 600;
// camera
glm::vec3 cameraPos   = glm::vec3(0.0f, 600.0f, 600.0f);
...
int main()
{
    ...
    motion.load("../bvh/16_25_walk, veer right.bvh");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        drawjoint(root, &motion.motionData,i*motion.motionData.num_motion_channels, ourShader);
        if( i< (motion.motionData.num_frames -1) )
            i++;
...
void drawjoint(JOINT* joint, MOTION* motionData, int frame_starts_index, Shader ourShader)
{
    ...
    for(auto& child : joint->children)
        drawjoint(child, motionData, frame_starts_index, ourShader);
}
