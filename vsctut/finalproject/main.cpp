...
// camera
glm::vec3 cameraPos   = glm::vec3(0.0f, 10.0f, 60.0f);
...
int main()
{
    ...
    Shader ourShader("../finalproject/vs.vs", "../finalproject/fs.fs");


    std::vector<glm::vec3>vertices1;
    std::vector<glm::vec2>uvs;
    std::vector<glm::vec3>normals;
    bool res = loadOBJ("../obj/sphere/sphere.obj", vertices1, uvs, normals);
    float vertices[] = {
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glDrawElements(GL_TRIANGLES, vertices1.size(), GL_UNSIGNED_SHORT, 0) ;
